...
const VerificationScreen: React.FC<VerificationScreenProps> = ({ language }) => {
  ...
  return (
    // Contenedor principal con fondo degradado y un efecto de partículas/patrón sutil
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden
                    bg-gradient-to-br from-blue-500 to-purple-600 
                    dark:from-gray-900 dark:to-black
                    font-sans text-gray-900 dark:text-white">
      
      {/* Overlay de partículas/patrón (simulado con CSS) */}
      ...
      <Card className="relative z-10 w-full max-w-md p-6 rounded-2xl 
                       ...
                       hover:scale-[1.01] hover:shadow-3xl"> {/* Sutil efecto al cargar/animar */}

        <CardHeader className="text-center pb-8 pt-12">
          {/* Contenedor del logo con un gradiente más interesante y animación */}
          <div className="mx-auto mb-6 w-24 h-24 rounded-full 
                          bg-gradient-to-br from-primary/30 to-primary/10 
                          flex items-center justify-center 
                          shadow-lg dark:shadow-xl dark:shadow-primary/20
                          animate-[pulse-slow_4s_infinite_ease-in-out]"> {/* Animación de pulso más lenta */}
            <img 
              src="/lovable-uploads/4a540878-1ca7-4aac-b819-248b4edd1230.png" 
              alt="GEESTOR Logo" 
              className="w-14 h-14 object-contain animate-bounce-subtle" // Animación de rebote sutil
            />
          </div>
        ...
        <CardContent className="text-center pb-12">
          {/* Spinner de carga más sofisticado */}
          <div className="flex flex-col items-center justify-center gap-4 mb-6">
            <div className="relative w-16 h-16">
              ...
              {/* Parte animada del spinner (simula un arco que se mueve) */}
              <div className="absolute inset-0 rounded-full border-4 border-t-4 border-t-primary border-transparent animate-[spin-arc_1.5s_linear_infinite]" />
            </div>
      ...
      <style jsx>{`
        ...
        /* Definir variables CSS para primary-color si no están ya en Tailwind config o globalmente */
        :root {
          --primary-color: #6366f1; /* Ejemplo de color primario, ajustar según tu tema */
        }
        .dark {
          --primary-color: #8b5cf6; /* Ejemplo de color primario para dark mode */
        }
