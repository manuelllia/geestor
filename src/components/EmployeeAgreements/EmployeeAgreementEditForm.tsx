      ...
      try {
        ...
        if (agreement) {
          setFormData({
            ...
            economicAgreement1: agreement.economicAgreement1?.toString() || '',
            concept1: agreement.concept1 || '',
            economicAgreement2: agreement.economicAgreement2?.toString() || '',
            concept2: agreement.concept2 || '',
            economicAgreement3: agreement.economicAgreement3?.toString() || '',
